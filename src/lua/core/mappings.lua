...
vim.keymap.set('n', '<leader>o', ':Neotree float git_status<CP>',    { noremap = true, silent = true })
vim.keymap.set({'n', 'i', 'v'}, '<A-n>', ':Neotree<CR>',             { noremap = true, silent = true })
vim.keymap.set('n', '<A-t>',      ':Themery<CR>',                    { noremap = true, silent = true })
...
vim.keymap.set('n', '<leader>cm', ':lua MiniMap.close()<CR>',        { noremap = true, silent = true })
...
vim.keymap.set('n', '<leader>c',  ':Telescope git_commits<CR>',      { noremap = true, silent = true })
vim.keymap.set('n', '<leader>s',  ':Telescope git_status<CR>',       { noremap = true, silent = true })
vim.keymap.set('n', '<A-o>',      ':Telescope oldfiles<CR>',         { noremap = true, silent = true })
vim.keymap.set('n', '<A-r>',      ':source %<CR>',                   { noremap = true, silent = true })
